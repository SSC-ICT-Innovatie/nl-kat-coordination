...
def test_load_bulk(
    ...
    networks = xtdb_ooi_repository.load_bulk({network.reference, network2.reference, network3.reference}, valid_time, include_scan_levels=False)
    ...
    networks = xtdb_ooi_repository.load_bulk({network.reference, network2.reference, network3.reference}, valid_time, include_scan_levels=True)
    assert [ooi.reference for ooi in networks.values()] == [network.reference, network2.reference, network3.reference]
