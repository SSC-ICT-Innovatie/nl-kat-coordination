...
.. image:: img/1-onboarding-welcome.jpg
...
.. image:: img/2-onboarding-organization-setup.jpg
...
.. image:: img/3-onboarding-organization-setup-meow.jpg
...
.. image:: img/4-onboarding-indemnification-setup.jpg
...
.. image:: img/5-onboarding-user-clearance-level.jpg
...
.. image:: img/6-onboarding-setup-scan-url.jpg
...
.. image:: img/7-onboarding-set-clearance-level.jpg
...
.. image:: img/8-onboarding-clearance-level-introduction.jpg
...
.. image:: img/8-onboarding-select-plugins.jpg
  :alt: Select plugins.

The final step is generating a report. During the onboarding, we will create a DNS-report.

.. image:: img/9-onboarding-generate-report.jpg
  :alt: Generate your DNS Report.

This is the last page, after which you can start exploring OpenKAT. The plugins are currently running to collect data about your URL. Your DNS Report will be generated in 3 minutes, so the plugins have some time to complete. In the meantime you can explore OpenKAT. Go back to the Report History page to view your DNS Report after a couple of minutes.

.. image:: img/10-onboarding-boefjes-loading.jpg
  :alt: Plugins are scanning.

After three minutes, you can open your DNS Report on the Report History page. Here is your very first DNS report! Congrats.

.. image:: img/11-onboarding-dns-report.jpg
  :alt: DNS report
