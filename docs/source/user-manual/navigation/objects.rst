...
- **Overview:** the overview tab gives object details, its creation information, related objects (objects that are somehow related), tasks that ran on this object, findings that are applicable to this object and available plugins that can scan this object.
