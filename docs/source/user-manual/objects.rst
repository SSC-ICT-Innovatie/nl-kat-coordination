...
The Objects page lists all the objects in OpenKAT (Octopoes). Objects can be anything, like DNS records, hostnames, URLs, software, software versions, ports, etc.
