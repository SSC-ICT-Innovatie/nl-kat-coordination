...
- Small documentation changes do not require rebuilding and restarting all services to perform a QA review.
- Properly gauge the impact of a feature: API changes affect current users.
