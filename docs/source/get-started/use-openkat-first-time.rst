Using OpenKAT for the first time
================================

The first time you log in to OpenKAT, you are guided through a short onboarding process.

The onboarding helps you configure OpenKAT and prepare it for your first use. You do not need to understand all of OpenKAT's features to complete it.
...
As an administrator, you can register new users on the "Members page". Read more about this page :doc:`here <../user-manual/members>`.
