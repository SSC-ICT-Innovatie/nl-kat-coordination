...
urlpatterns += i18n_patterns(
    ...
    path("<organization_code>/<temporal_context>/findings/mute/", MuteFindingView.as_view(), name="finding_mute"),
    path(
    ...
    path("<organization_code>/<temporal_context>/kat-alogus/", include("katalogus.urls"), name="katalogus"),
